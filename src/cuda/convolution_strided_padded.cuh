...
inline void block_convolution_strided_padded_launcher(T* data, T* kernel, unsigned int inner_batch_count, unsigned int outer_batch_count, int s) {
    ...
    CUDA_CHECK_AND_EXIT(cudaFuncSetAttribute(
        block_convolution_strided_padded_kernel<FFT, FFT_inv>,
...
int block_convolution_strided_padded(T* data, T* kernel, unsigned int inner_batch_count,  unsigned int outer_batch_count, int s) {
    ...
    /* clang-format off */
    switch (arch) {
        case 800: block_convolution_strided_padded_launcher<800, T, FFTSize, elements_per_thread, FFTs_per_block>(data, kernel, inner_batch_count, outer_batch_count, s); break;
        case 860: block_convolution_strided_padded_launcher<860, T, FFTSize, elements_per_thread, FFTs_per_block>(data, kernel, inner_batch_count, outer_batch_count, s); break;
        case 870: block_convolution_strided_padded_launcher<870, T, FFTSize, elements_per_thread, FFTs_per_block>(data, kernel, inner_batch_count, outer_batch_count, s); break;
        case 890: block_convolution_strided_padded_launcher<890, T, FFTSize, elements_per_thread, FFTs_per_block>(data, kernel, inner_batch_count, outer_batch_count, s); break;
        case 900: block_convolution_strided_padded_launcher<900, T, FFTSize, elements_per_thread, FFTs_per_block>(data, kernel, inner_batch_count, outer_batch_count, s); break;
        case 1200: block_convolution_strided_padded_launcher<900, T, FFTSize, elements_per_thread, FFTs_per_block>(data, kernel, inner_batch_count, outer_batch_count, s); break; 
        default:
